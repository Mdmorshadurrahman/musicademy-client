            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div  className="absolute flex justify-between transform -translate-y-1/2 left-40 right-5 top-1/4">
                        <h1 className=' font-medium text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-white'>
                           Start Your Musical<br /> Journey & <br />Be a Pro <br /> in <span className='text-violet-600'>NO TIME!!!</span>  
                        </h1>
                    </div>
                    <div  className="mt-10 absolute flex flex-col justify-between transform -translate-y-1/2 left-40 right-5 top-1/2">
                        <p className='text-md lg:text-lg xl:text-xl 2xl:text-2xl text-white w-2/5 mb-5'>
                            Lots of varity in course selection,flexible lesson time, Learn from The Expert
                        </p>
                        <div className='w-2/5 '>
                        <NavLink to={'/login'}><button className=' text-5xl border-2 border-black hover:bg-violet-600 py-2 lg:py-3 xl:py-5 rounded-lg hover:text-white'>Enroll</button></NavLink>
                        </div>
                    </div>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div  className="w-2/5 absolute flex justify-between transform -translate-y-1/2 left-40 right-5 top-1/4">
                        <h1 className='font-light text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-white'>
                    ...
                    <div  className="absolute flex flex-col justify-between transform -translate-y-1/2 left-48 right-5 bottom-2/4">
                        <p className='text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl text-white font-light w-2/5'>
